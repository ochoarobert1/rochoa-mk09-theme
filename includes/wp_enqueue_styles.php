...
function rochoa_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- MAIN STYLE -*/
        wp_register_style('main-style', get_template_directory_uri() . '/css/rochoa-style.css', false, $version_remove, 'all');
        wp_enqueue_style('main-style');

        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/rochoa-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('wp_enqueue_scripts', 'rochoa_load_css');
